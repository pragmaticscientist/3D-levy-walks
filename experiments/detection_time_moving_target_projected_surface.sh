...
# === OAR directives ===
#OAR -l /nodes=1/core=50,walltime=12:00:00
#OAR -O OAR_%jobid%.out
#OAR -E OAR_%jobid%.err
#OAR -n moving-target-projected-surface

cd "$(dirname "$0")/.."

SOURCE_FILE="simulation.c"
LIB_FILES=("func.c" "helpers.c")
EXECUTABLE_NAME="simulation_executable_moving_target_$$"
CONFIG_FILE="./experiments/configs/detection_time_projected_surface_moving_target.conf"
...
echo "Moving-target simulation completed successfully."
