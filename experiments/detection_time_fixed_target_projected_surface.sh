...
#OAR -n fixed-target-projected-surface

cd "$(dirname "$0")/.."

SOURCE_FILE="simulation.c"
LIB_FILES=("func.c" "helpers.c")
EXECUTABLE_NAME="simulation_executable_fixed_target_$$"
CONFIG_FILE="./experiments/configs/detection_time_projected_surface_fixed_target.conf"
...
echo "Fixed-target simulation completed successfully."
